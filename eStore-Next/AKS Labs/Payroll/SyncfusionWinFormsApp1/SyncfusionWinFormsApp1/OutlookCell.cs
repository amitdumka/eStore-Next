...
namespace SyncfusionWinFormsApp1
{
    class OutlookCell
    {
        #region Grid Text cell renderer part
        /// <summary>
        ...
        public class OutlookHeaderCellRenderer : GridOriginalTextBoxCellRenderer
        {
            ...
            ImageList gridimages = new ImageList();
        /// <summary>
...
#if ISNETCORE
                gridimages.Images.Add(System.Drawing.Image.FromFile("..\\..\\..\\Resources\\Run rules now.png"));
                gridimages.Images.Add(System.Drawing.Image.FromFile("..\\..\\..\\Resources\\delete.png"));
                gridimages.Images.Add(System.Drawing.Image.FromFile("..\\..\\..\\Resources\\Run rules now1.png"));
                gridimages.Images.Add(System.Drawing.Image.FromFile("..\\..\\..\\Resources\\flag.png"));
#else
            gridimages.Images.Add(System.Drawing.Image.FromFile("..\\..\\Resources\\Run rules now.png"));
            gridimages.Images.Add(System.Drawing.Image.FromFile("..\\..\\Resources\\delete.png"));
            gridimages.Images.Add(System.Drawing.Image.FromFile("..\\..\\Resources\\Run rules now1.png"));
                    ...
                    if (moveRowIndex == rowIndex && moveColIndex == colIndex)
                    {
                        ...
                        if (closeImage.Contains(e.Location))
                        {
                            if (clickedRow == rowIndex)
                                clr = ColorTranslator.FromHtml("#CDE6F7");
                            g.FillRectangle(new SolidBrush(clr), closeImage);
                            g.DrawImage(gridimages.Images[0], closeImage);
                            hoveredClose = true;
                        }
                        else
                            g.DrawImage(gridimages.Images[1], closeImage);//Change icon here.
                        if (flagImage.Contains(e.Location))
                        {
                            if (clickedRow == rowIndex)
                                clr = ColorTranslator.FromHtml("#CDE6F7");
                            g.FillRectangle(new SolidBrush(clr), flagImage);
                            g.DrawImage(gridimages.Images[2], flagImage);
                            hoveredFlag = true;
                        }
                        else
                            g.DrawImage(gridimages.Images[3] , flagImage);//change icon here.
