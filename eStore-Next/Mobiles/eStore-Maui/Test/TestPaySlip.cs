...
namespace eStore_Maui.Test
{
    public class TestPaySlip
    {
        public static void Print()
        {
            ...
            Absent=1, BasicDayRate=503, CurrentMonthSalary=5000, FileName="Test.pdf", 
            Page2Inch=true, Incentive=0, IsDataSet=true, LastMonthAdvance=1000, LastPcs=0, 
            Month=3, NetPayableSalary=6000, NoOfCopy=2, PathName=@"ARD/Payslip/",PaySlipNo="Test001", 
