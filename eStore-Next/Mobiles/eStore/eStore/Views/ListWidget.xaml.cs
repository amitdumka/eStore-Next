...
public partial class ListWidget : ContentView
{
    ...
    public static readonly BindableProperty ItemDataProperty = BindableProperty.Create(nameof(ItemData), typeof(List<ItemList>), typeof(WidgetStat), null);
   ...
   // public static readonly BindableProperty DescriptionProperty = BindableProperty.Create(nameof(Description), typeof(string), typeof(WidgetStat), string.Empty);
    ...
    {
        get => (List<ItemList>)GetValue(ItemDataProperty);
